...
const state = {
  ...
  keepAlivePages: [], // The component name of the keepAlive pages
...
const mutations = {
  ...
  setLadlActions(state, item) {
    state.ladlActions = JSON.stringify(item)
  },
}
...
const actions = {
  ...
  setLadlActions(context, ladlActions) {
    context.commit('setLadlActions', ladlActions)
  },
}
...
const getters = {
  ...
  getLadlActions: state => {
    return JSON.parse(state.ladlActions)
  },
}
